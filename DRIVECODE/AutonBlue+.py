...
def autonomous():
    controller_1.screen.print("Running Auton Blue+")
    # Auton code
    bot.drive_for(REVERSE, 7,INCHES)
    bot.turn_for(LEFT, 26,DEGREES)
    bot.drive_for(REVERSE, 4,INCHES)
    mogoout()
    bot.turn_for(RIGHT, 120,DEGREES)
    startIntake()
    bot.drive_for(FORWARD, 6,INCHES)
    bot.turn_for(RIGHT, 130,DEGREES)
